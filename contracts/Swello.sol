...
contract Swello is UUPSUpgradeable, OwnableUpgradeable, IERC20 {
    ...
    function __Swello_init_unchained(
        ...
        // emit Transfer(ZERO, msg.sender, _gonBalances[msg.sender] / _gonsPerFragment);
        // emit Transfer(ZERO, FOUNDER1, _gonBalances[FOUNDER1] / _gonsPerFragment);
        // emit Transfer(ZERO, FOUNDER2, _gonBalances[FOUNDER2] / _gonsPerFragment);
    }
